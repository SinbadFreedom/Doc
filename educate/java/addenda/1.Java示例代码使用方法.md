...
![图a-8](http://localhost/img/java/addenda/a-8.png)

![图a-9](http://localhost/img/java/addenda/a-9.png)

![图a-10](http://localhost/img/java/addenda/a-10.png)

![图a-11](http://localhost/img/java/addenda/a-11.png)

![图a-12](http://localhost/img/java/addenda/a-12.png)

![图a-13](http://localhost/img/java/addenda/a-13.png)

![图a-14](http://localhost/img/java/addenda/a-14.png)

![图a-15](http://localhost/img/java/addenda/a-15.png)

![图a-16](http://localhost/img/java/addenda/a-16.png)
...
![图a-17](http://localhost/img/java/addenda/a-17.png)

在想运行的源码上点击右键(例如:`HelloWorld`)->`Run 'HelloWrold.main()'`.   

如图:

![图a-18](http://localhost/img/java/addenda/a-18.png)
...
![图a-19](http://localhost/img/java/addenda/a-19.png)