...
Java中方法中给变量赋值有2种方式: 值传递和引用传递.    
传递基本类型,String参数时是值传递. 传递引用类型参数时, 是引用传递.
...
<div class="bs-callout bs-callout-warning">
	<h4>抽象类不能用来创建对象吗?   </h4>
	<p>答案是`假`的.</p>
	<p>抽象类可以被用`new`的方式创建. 通过`匿名内部类`方式.</p>
</div>
...
<div class="bs-callout bs-callout-info">
	<p>示例代码中出现了`@Override`标签.</p>
	<p><a href="http://localhost/article/java/addenda/java中@Override标签作用.html">java中@Override标签作用</a></p>
</div>
