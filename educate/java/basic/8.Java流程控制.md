...
<div class="bs-callout bs-callout-danger">
	<h4>网上很多文章说`switch`只支持整数型和字符(`char`)型. 那是以前了. JDK7.0开始`switch case`已经支持字符串类型了.</h4>
</div>
...
```
<div class="bs-callout bs-callout-success">			<h4>在`for`循环和`while`循环中,`continue`语句作用一样. 当`i==1`时,执行了`continue`语句,跳过了后续的语句,所以没有输出`i: 1`.</h4>
</div>
