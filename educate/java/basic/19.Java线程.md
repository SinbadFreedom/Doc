...
![线程](http://localhost/img/java/basic/18-1.jpg =480x360)   
...
在Java中想实现多线程有两种手段,一种是继承Thread类,另一种就是实现Runnable接口.
...
8 java线程synchronized用在对象,方法,代码块的区别
===
...
![爱因斯坦](http://localhost/img/common/aiyinsitan.jpg =480x360)