<div class="jumbotron">
	<p>Java是面向对象编程(Object Oriented Programming)语言.java面向对象的三大特点:封装,继承和多态.</p>  
</div> 
