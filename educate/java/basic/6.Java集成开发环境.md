...
![图a-a](http://localhost/img/java/basic/a-a.png =480x360)
		
2 java常用文本编辑工具
===
文本类的工具在编程中,比较常用.现在有很多人保有采用文本工具编程的习惯.这个相当于是:拿螺丝刀拧螺丝.

![图a-b](http://localhost/img/java/basic/a-b.png =480x360)
...
![图a-c](http://localhost/img/java/basic/a-c.png =480x360)
...
![图a-1](http://localhost/img/java/basic/a-1.png =480x360)

第二步选择安装目录,如图:

![图a-2](http://localhost/img/java/basic/a-2.png =480x360)

第三步选择桌面图标,如图:

![图a-3](http://localhost/img/java/basic/a-3.png =480x360)

第四步点下一步,如图:

![图a-4](http://localhost/img/java/basic/a-4.png =480x360)

第五步Intelij IDEA安装完成,如图:

![图a-5](http://localhost/img/java/basic/a-5.png =480x360)
...
![图a-6](http://localhost/img/java/basic/a-6.png =480x360)
...
![图a-7](http://localhost/img/java/basic/a-7.png =480x360)
...
![图a-8](http://localhost/img/java/basic/a-8.png =480x360)

- 第2步

![图a-9](http://localhost/img/java/basic/a-9.png =480x360)

- 第3步

![图a-10](http://localhost/img/java/basic/a-10.png =480x360)

- 第4步

![图a-11](http://localhost/img/java/basic/a-11.png =480x360)

- 第5步

![图a-12](http://localhost/img/java/basic/a-12.png =480x360)

- 第6步

![图a-13](http://localhost/img/java/basic/a-13.png =480x360)

- 第7步

![图a-14](http://localhost/img/java/basic/a-14.png =480x360)

- 第8步

![图a-15](http://localhost/img/java/basic/a-15.png =480x360)

- 第9步

![图a-16](http://localhost/img/java/basic/a-16.png =480x360)
...
![图a-17](http://localhost/img/java/basic/a-17.png =480x360)

在想运行的源码上点击右键(例如:HelloWorld)->Run HelloWrold.main().如图:

![图a-18](http://localhost/img/java/basic/a-18.png =480x360)
...
![图a-19](http://localhost/img/java/basic/a-19.png =480x360)
